/**
 * Kingdom Nexus - Admin Settings JS (v3.2)
 * ----------------------------------------
 * Handles Google Maps API key saving through REST API with nonce authentication.
 * Provides live validation via map preview and toast notifications.
 */
    ...
    try {
      const res = await fetch(api, {
        ...
        headers: { 
          ...
          "X-WP-Nonce": nonce // ✅ Proper WordPress REST nonce header
        },
