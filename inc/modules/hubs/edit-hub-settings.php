...
$nonce = wp_create_nonce('knx_update_settings_action');
?>
...
<!-- Load Styles & JS -->
<link rel="stylesheet" href="<?php echo esc_url(KNX_URL . 'inc/modules/hubs/css/edit-hub-settings-style.css'); ?>">
<script src="<?php echo esc_url(KNX_URL . 'inc/modules/hubs/js/edit-hub-settings.js'); ?>"></script>
